/** Türkiye il->ilçe eşleme tablosu (il id'ye göre) */
export const ILCE_MAP: Record<number, string[]> = {
  ...
  18: ['Atkaracalar','Bayramören','Çerkeş','Eldivan','Ilgaz','Korgun','Kurşunlu','Merkez','Orta','Şabanözü','Yapraklı'],
  19: ['Alaca','Bayat','Boğazkale','Dodurga','İskilip','Kargı','Laçın','Mecitözü','Merkez','Oğuzlar','Ortaköy','Osmancık','Sungurlu','Uğurludağ'],
  ...
  22: ['Enez','Havsa','İpsala','Keşan','Lalapaşa','Merkez','Meriç','Süloğlu','Uzunköprü'],
  ...
  25: ['Aşkale','Aziziye','Çat','Hinis','Horasan','İspir','Karaçoban','Karayazı','Köprüköy','Merkez','Narman','Oltu','Olur','Palandöken','Pasinler','Pazaryolu','Şenkaya','Tekman','Tortum','Uzundere','Yakutiye'],
  ...
  44: ['Akçadağ','Arapgir','Arguvan','Battalgazi','Darende','Doğanhisar','Doğanyol','Hekimhan','Kale','Kuluncak','Pütürge','Yazıhan','Yeşilyurt'],
  45: ['Ahmetli','Akhisar','Alaşehir','Demirci','Gölmarmara','Gördes','Kırkağaç','Köprübaşı','Kula','Salihli','Sarıgöl','Saruhanlı','Selendi','Soma','Turgutlu','Yunusemre'],
  ...
  58: ['Akıncılar','Altınyayla','Divriği','Doğanşar','Gemerek','Gölova','Gürun','Hafik','İmranlı','Kangal','Koyulhisar','Merkez','Suşehri','Şarkışla','Ulaş','Yıldızeli','Zara'],
  ...
  72: ['Beşiri','Gercüş','Hasankeyif','Kozluk','Merkez','Sason'],
...
/** İl adından ilçe listesi döndürür */
export function getIlceler(ilAdi: string): string[] {
  ...
  const il = IL_LISTESI.find(i => i.ad === ilAdi);
  return il ? (ILCE_MAP[il.id] ?? []) : [];
}
