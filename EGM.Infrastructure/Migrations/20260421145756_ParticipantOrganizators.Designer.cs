...
namespace EGM.Infrastructure.Migrations
{
    ...
    [Migration("20260421145756_ParticipantOrganizators")]
    partial class ParticipantOrganizators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlayOrganizator", b =>
                {
                    b.Property<Guid>("KatilimciOlduguOlaylarId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("ParticipantOrganizatorsId")
                        .HasColumnType("TEXT");

                    b.HasKey("KatilimciOlduguOlaylarId", "ParticipantOrganizatorsId");

                    b.HasIndex("ParticipantOrganizatorsId");

                    b.ToTable("OlayKatilimciOrganizator", (string)null);
                });
            ...
            modelBuilder.Entity("OlayOrganizator", b =>
                {
                    b.HasOne("EGM.Domain.Entities.Olay", null)
                        .WithMany()
                        .HasForeignKey("KatilimciOlduguOlaylarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EGM.Domain.Entities.Organizator", null)
                        .WithMany()
                        .HasForeignKey("ParticipantOrganizatorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
